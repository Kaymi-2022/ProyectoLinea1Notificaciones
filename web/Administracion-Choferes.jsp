                    ...
                    <div class="container my-5">
                        <div class="row">
                            <table id="example" class="table table-striped" style="width: 100%">
                                ...
                                <tbody>
                                    <c:forEach var="e" items="${conductores}">
                                        <tr>
                                            <td>${e.getIdConductor()}</td>
                                            <td>${e.getCodigo()}</td>
                                            <td>${e.getNombre()}</td>
                                            <td>${e.getDNI()}</td>
                                            <td>${e.getClave()}</td>
                                            <td>
                                                <button type="button" class="btn btn-primary botonEditar col-9 mx-auto" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModal">Editar</button>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-danger botonEditar col-9 mx-auto" data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Datos de los Choferes</h5>
                        ...
                        <form action="" method="POST" method="POST" role="form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="txtId" class="form-control" name="txtIdconductor" id="txtIdconductor" readonly="true">
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-6">
                                    <label for="codigo">CODIGO</label>
                                    <input type="text" class="form-control" name="txtcodigo" id="txtcodigo" readonly="true">
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="text" required placeholder="Clave" name="txtclave" id="txtclave">
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-12">
